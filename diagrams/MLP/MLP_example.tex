...
\begin{tikzpicture}
    \begin{pgfonlayer}{nodelayer}
        ...
        \node [style=myText] (50) at (0, -4) {\large (8)};
        \node [style=myText] (51) at (0, -2.75) {\large Parameter};
        \node [style=myText] (52) at (0, -3.25) {\large vector};

        \node [style=myText] (60) at (8.5, -4) {\large (1500)};
        \node [style=myText] (61) at (8.5, -2.75) {\large Profile};
        
        \node [style=myText] (51) at (4, -2.75) {\large Hidden layers};
