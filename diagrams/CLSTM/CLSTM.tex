...
\begin{tikzpicture}
    \begin{pgfonlayer}{nodelayer}
        % layer 1
        \node [style={parameter_vector}] (0)      at (1.5, 0) {};
        \node [style={parameter_vector}] (3)      at (1.5, 3) {};
        \node [style={parameter_vector}] (4)      at (1.5, 4) {};
        \node [style={empty_slot}, scale=0.5] (5) at (1.5, 2) {};
        \node [style={empty_slot}, scale=0.5] (6) at (1.5, 1) {};

        %layer 2
        \node [style={hidden_layer_unit}] (7)      at (3.0, 4.5) {};
        \node [style={hidden_layer_unit}] (8)      at (3.0, 3.5) {};
        \node [style={hidden_layer_unit}] (9)      at (3.0, -0.5) {};
        \node [style={empty_slot}, scale=0.5] (11) at (3.0, 2.5) {};
        \node [style={empty_slot}, scale=0.5] (12) at (3.0, 1.5) {};
        \node [style={empty_slot}, scale=0.5] (13) at (3.0, 0.5) {};
...
%         \node [style={empty_slot}, scale=0.5] (78) at (11, 3) {};
        ...
        \node [style=myText] (79) at (1.5, -6.5) {\large (8)};
        \node [style=myText] (80) at (3.0, -6.5) {\large (64)};
        ...
        \node [style=myText] (90) at (1.5, -5.5) {\large Parameter};
        \node [style=myText] (91) at (1.5, -6.0) {\large vector};
