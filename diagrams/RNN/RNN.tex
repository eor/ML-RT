...
\begin{tikzpicture}
    \begin{pgfonlayer}{nodelayer}
        ...
        % RNN output layer
        \node [style={hidden_layer_unit}] (65)     at (9, 5.25) {};
        \node [style={hidden_layer_unit}] (66)     at (9, 4.75) {};
        \node [style={hidden_layer_unit}] (67)     at (9, 4.25) {};
        \node [style={hidden_layer_unit}] (68)     at (9, 5.75) {};
        \node [style={hidden_layer_unit}] (69)     at (9, -1.75) {};
        \node [style={hidden_layer_unit}] (70)     at (9, -1.25) {};
        \node [style={empty_slot}, scale=0.5] (79) at (9, 3.75) {};
        \node [style={empty_slot}, scale=0.5] (80) at (9, 2.75) {};
        \node [style={empty_slot}, scale=0.5] (81) at (9, 1.75) {};
        \node [style={empty_slot}, scale=0.5] (82) at (9, 0.75) {};
        \node [style={empty_slot}, scale=0.5] (83) at (9, -0.25) {};
        \node [style={empty_slot}, scale=0.5] (84) at (9, 3.25) {};
        \node [style={empty_slot}, scale=0.5] (85) at (9, 2.25) {};
        \node [style={empty_slot}, scale=0.5] (86) at (9, 1.25) {};
        \node [style={empty_slot}, scale=0.5] (87) at (9, 0.25) {};
        \node [style={empty_slot}, scale=0.5] (88) at (9, -0.75) {};
        ...
        \node [style=myText] (79) at (0.5, -3) {\large (8)};
        \node [style=myText] (80) at (2.5, -3) {\large (64)};
        \node [style=myText] (81) at (5, -3) {\large (2x1500)};
        \node [style=myText] (82) at (7, -3) {\large (2x1500)};
        \node [style=myText] (83) at (9, -3) {\large (4x1500)};
        \node [style=myText] (84) at (11, -3) {\large (1500)};
        
        
        % description at the bottom 
        \node [style=myText] (90) at (0.5, -3.75) {\large Parameter};
        \node [style=myText] (91) at (0.5, -4.25) {\large vector};

        
        \node [style=myText] (92) at (5, -3.75) {\large Embedding};
        \node [style=myText] (93) at (5, -4.25) {\large layer};

        \node [style=myText] (94) at (11, -3.75) {\large Profile};
        
        % description at the top   
        \node [style=myText] (95) at (7.0,  7.0) {\large RNN block};
        \node [style=myText] (96) at (3.0,  7.0) {\large MLP block};
        \node [style=myText] (97) at (10.0, 7.0) {\large MLP block};
        
        % epmty nodes for docking the lines at the top 
        \node [style=none] (100) at (0.5,  6.5) {};
        \node [style=none] (101) at (5.0,  6.5) {};
        
        \node [style=none] (102) at (5.5,  6.5) {};        
        \node [style=none] (103) at (8.5,  6.5) {};
        
        \node [style=none] (104) at (9.0,  6.5) {};
        \node [style=none] (105) at (11.0, 6.5) {};
    ...
    \begin{pgfonlayer}{edgelayer}
        ...
        \draw [style={main_connector}] (57) to (70);
        \draw [style={main_connector}] (57) to (69);
        \draw [style={main_connector}] (55) to (68);
        \draw [style={main_connector}] (55) to (65);
        \draw [style={main_connector}] (56) to (66);
        \draw [style={main_connector}] (56) to (67);
