...
\begin{tikzpicture}
    \begin{pgfonlayer}{nodelayer}
        ...
        \node [style=myText] (81) at (5, -4.5) {\large (2x1500)};
        \node [style=myText] (82) at (7, -4.5) {\large (2x1500)};
        \node [style=myText] (83) at (9, -4.5) {\large (4x1500)};
        \node [style=myText] (84) at (11, -4.5) {\large (1500)};
        ...
        \node [style=myText] (94) at (11, -3.) {\large Profile};
