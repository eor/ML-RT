...
# -----------------------------------------------------------------
def cgan_train_discriminator(real_profiles, real_parameters, gen_profiles, gen_parameters, discriminator, optimizer, loss, batch_size):
    """
    ...
    Args:
        ...
        real_parameters: parameters correpsonding to real_profiles from the dataset
